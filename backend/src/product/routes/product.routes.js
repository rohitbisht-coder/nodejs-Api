...
// POST Routes
// admin-only
router.route("/add").post(auth, authByUserRole, addNewProduct);
router.route("/update/:id").put(auth, authByUserRole, updateProduct);

// DELETE ROUTE
// Admin only
router
  .route("/delete/:id")
  .delete(auth, authByUserRole, deleteProduct);
